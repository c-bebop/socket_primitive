...
\lstinputlisting[language=C++]{../primitive_data_types_in_cpp/primitive_data_types_main.cpp}

\newpage

\section{Build Script (Makefile) of the C++ Application}\label{makefile}

\lstinputlisting[language=make]{../primitive_data_types_in_cpp/Makefile}
